...
//use javascript or action class
		...
		String text = driver.findElement(By.xpath("//lightning-formatted-text[text()='Salesforce automation by Nirmalraj']")).getText();
	if (text.equals("Salesforce automation by Nirmalraj")) {
